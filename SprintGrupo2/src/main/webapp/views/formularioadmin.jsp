...
<head>
    ...
    <title>Creación Administrativo</title>
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form action="guardarAdministrativo" method="post" class="mt-4">
            <div class="form-group">
                <label for="nombre">Área:</label>
                <input type="text" id="area" name="area" class="form-control" required>
            </div>
            <div class="form-group">
                <label for="apellidoCliente">Experiencia Previa:</label>
                <input type="text" id="experiencia" name="experiencia" class="form-control" required>
            </div>
            <div class="mt-3">
